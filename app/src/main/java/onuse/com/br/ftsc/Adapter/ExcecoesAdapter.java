...
public class ExcecoesAdapter extends ArrayAdapter<Execoes> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(execoes != null)
        {
            ...
            TextView textQtdeExecoes = view.findViewById(R.id.qtdeExecoes); //Armazena a quantidade de exeções
            ImageView imageConversa =  view.findViewById(R.id.imagemExecoes);
            final CheckBox checkbox = (CheckBox) view.findViewById(R.id.checkExecoes);
            ...
            textQtdeExecoes.setText(""+execao.getQtdeExecoes());
           /* if(execao.getTipoExecao() == 0){
            ...
            checkbox.setTag(execao);
            if(execao.isChecado()) {
                checkbox.setVisibility(View.VISIBLE);
                checkbox.setChecked(execao.getEstaChecado());//seta se está checado
                checkbox.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        CheckBox check = (CheckBox)    v;
                        Execoes item = (Execoes) check.getTag();//adiciona ao models se checou ou nao
