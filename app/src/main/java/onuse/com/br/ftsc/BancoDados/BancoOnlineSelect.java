...
public class BancoOnlineSelect {
    ...
    private void InterfaceAtualizacao(){
        ...
        if(tabela == 0)
            ...
            ((ListaAdaptados) context).AtualizarLista(1);
        else if(tabela == 2)
            ((ListaExecoes) context).AtualizarLista(1);
        else if(tabela == 3)
            ((ListaExecoes) context).AtualizarLista(2);
        else if(tabela == 4)
            ((ListaAdaptados) context).AtualizarLista(2);
    }
}
